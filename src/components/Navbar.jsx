const Navbar = () => {
  return (
    <div className="absolute top-[0rem] left-[14rem] bg-black-100 box-border w-[76rem] flex flex-row items-center justify-start py-[0.75rem] px-[2rem] gap-[1rem] border-b-[1px] border-solid border-black-85 font-body-1-medium">
      <div className="flex-1 flex flex-row items-center justify-start gap-[1rem]">
        <div className="overflow-hidden flex flex-row items-center justify-start">
          <div className="relative leading-[1.75rem] font-medium">Payments</div>
        </div>
        <div className="flex flex-row items-center justify-start gap-[0.38rem] text-[0.75rem] text-black-30">
          <img
      ...
      <div className="self-stretch rounded-md bg-black-95 w-[25rem] flex flex-row items-center justify-start py-[0.56rem] px-[1rem] box-border gap-[0.5rem] text-[0.94rem] text-black-50">
        <img
          className="relative w-[1rem] h-[1rem] overflow-hidden shrink-0 object-cover"
          alt=""
          src="/search.svg"
        />
        <div className="relative leading-[1.38rem]">
