...
const Dashboard = () => {
  return (
    <div className="absolute top-[6rem] left-[0] md:left-[14rem] md:px-[2rem] w-full bg-red-400 md:w-[72rem] flex flex-col items-start justify-start gap-[2rem] font-body-1-medium">
