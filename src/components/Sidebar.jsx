const Sidebar = () => {
  return (
    <div className="absolute top-[0rem] left-[0rem] h-[92.63rem] flex flex-col items-start justify-start text-[0.94rem] text-black-100 font-body-1-medium">
      <div className="flex-1 bg-secondary-navbar w-[14rem] flex flex-col items-center justify-start py-[1rem] px-[0.63rem] box-border gap-[1rem]">
